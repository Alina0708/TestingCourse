//3.	 Выбрать определенный товар - КЕДЫ VANS ULTRARANGE VR3  и КЕДЫ VANS OLD SKOOL GRAPHIC CHECK


const {Builder, By, until, Key} = require ('selenium-webdriver');

async function VariosThings() {
...
//2.	На главной странице выбрать необходимую категорию (обувь)/
 ...
 //3. Нажать на поле поиска и ввести КЕДЫ VANS ULTRARANGE VR3
...
//----
 //7 Кликнуть на КЕДЫ VANS SK8-HI
 await driver.findElement(By.xpath(" /html/body/div[3]/div[2]/section/div/div/div[4]/div/div[1]/div/a/div[1]/img")).click();

 //8  Кликнуть на выпадающий список
 await driver.findElement(By.xpath("/html/body/div[3]/div[2]/section/div/div/div[1]/article/div[2]/div[1]/div[2]/div/div[2]/div[1]/div[2]/span")).click();

  //9.	Указать размер выбранного товара Rus 39
  await driver.findElement(By.xpath("/html/body/div[3]/div[2]/section/div/div/div[1]/article/div[2]/div[1]/div[2]/div/div[2]/div[2]/div/div[2]")).click();
