//	 Добавление в корзину товаров в разном количестве (2 шт)
...
//2.	На главной странице выбрать необходимую категорию (обувь)/
 ...
 //7. Увеличить количество товаров на единицу
 await driver.findElement(By.xpath("/html/body/div[7]/aside/div[2]/div/div[2]/div[2]/div/div/span[2]")).click();
