...
//2.	На главной странице выбрать необходимую категорию (обувь)/
 ...
 //7 нажать на иконку корзины
 //await driver.findElement(By.xpath("/html/body/div[3]/header[1]/div/div/div/div[1]/div/div/div[1]/div[1]/div/a/span[1]/svg")).click();
 await driver.sleep(5000);
 //8 Нажать на иконку мусорки в корзине
 await driver.findElement(By.xpath("/html/body/div[7]/aside/div[2]/div/div[2]/div[1]/button")).click();
 //await driver.quit();
